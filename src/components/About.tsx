export const About = () => {
  const timeline = [
    ...
    { year: "1997", title: "West2Peu — the crew", text: "Back in Constanța, he founded West2Peu, the first hip-hop crew in the city, later becoming a breaking crew, named K'Virus that defined that era. Stage name: A2PEU  . Battles, jams, street cyphers — they ran the city." },
    { year: "late 90s", title: "Crew legacy", text: "A2Peu became one of the most respected b-boys of the 90's - 2000's generation — putting Constanța on the map for break dancing culture in Romania." },
    ...
    { year: "now", title: "Behind the decks", text: "Transitioned into DJ-ing, becoming Sasha Deejay, and travelled around the world — and never looked back. 45 and still spinning since 2005." },
  ];
      ...
      <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-start">
        <div className="lg:col-span-5 lg:sticky lg:top-24">
          ...
          <p className="mt-6 text-2xl font-light leading-snug text-foreground">
            From Moldova to Reșița to Constanta to all over the world. From break dance to the booth.
